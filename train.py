...
intersection_over_union,cellboxes_to_boxes,get_bboxes,plot_image,
...
PIN_MEMORY = True
LOAD_MODEL = False
LOAD_MODEL_FILE = "Trained_Yolo_V1.pth"
IMG_DIR = "data/images"
...
def main():
    ...
    train_dataset = VOCDataset(r"C:\Users\dipesh\Desktop\Pascal Voc\100examples.csv",transform=transform,img_dir=IMG_DIR,label_dir=LABEL_DIR)

    test_dataset = VOCDataset(r"C:\Users\dipesh\Desktop\Pascal Voc\test.csv", transform=transform, img_dir=IMG_DIR, label_dir=LABEL_DIR,)
